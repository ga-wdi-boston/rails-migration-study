...
```md
Migrations is a domain-specific language used for managing a database schema.  Developers use them because it  makes it easy to alter database schemas.
```
...
```md
Application seed data is a feature that creates initial data used in development and test environments.
```
