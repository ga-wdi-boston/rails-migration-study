...
```md
Migrations change the database schema and allows you to save "versions" of the
structure of that data by isolating changes to its own file. This gives
developers the ability to share database states amongst a team.
```
...
```md
Seed data essentially populates the database with fake values using your schema.
```
